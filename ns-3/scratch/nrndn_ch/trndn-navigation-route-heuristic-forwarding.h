...
#ifndef TRNDN_NAVIGATION_ROUTE_HEURISTIC_FORWARDING_H_
#define TRNDN_NAVIGATION_ROUTE_HEURISTIC_FORWARDING_H_
 ...
 */
class TrNavigationRouteHeuristic: public GreenYellowRed
{
public:
	static TypeId
	GetTypeId(void);
	...
	TrNavigationRouteHeuristic ();

	virtual ~TrNavigationRouteHeuristic ();
...
private:
	...
	bool inIdList(std::vector<uint32_t> idlist, uint32_t id);
...
private:
	...
	Ptr<ndn::pit::nrndn::TrNrPitImpl> m_pit;
	Ptr<ndn::fib::nrndn::TrNrFibImpl> m_fib;
