...
#ifndef 	TRPRODUCER_H_
#define  TRPRODUCER_H_
...
public:
	...
	/////发送资源包
	void sendResourcePacket(uint32_t n);
...
private:
	...
	typedef App super;
	Ptr<fw::nrndn::TrNavigationRouteHeuristic>	m_forwardingStrategy;
