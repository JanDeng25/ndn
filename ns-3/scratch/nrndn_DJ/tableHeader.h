...
public:
	...
	void addPIT(Ptr<pit::nrndn::EntryNrImpl> tempPitEntry)
	{
		m_pitContainer.push_back(tempPitEntry);
	}

	void addFIB(Ptr<fib::nrndn::EntryNrImpl> tempFibEntry)
	{
		m_fibContainer.push_back(tempFibEntry);
	}
private:
